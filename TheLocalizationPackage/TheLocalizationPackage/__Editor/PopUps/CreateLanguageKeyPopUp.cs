...
{
    public class CreateLanguageKeyPopUp : EditorWindow
    {
        ...
        public static void Show(LanguagePartitionSO _tipe, LanguageKeyHandler _handler, LanguageCreatorHandler _languages, string _path, Action _cancel, Action<LanguageKeySO> _selectedKey)
        {
            var window = CreateInstance<CreateLanguageKeyPopUp>();
